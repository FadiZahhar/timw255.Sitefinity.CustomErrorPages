var CustomErrorPageItemsMaster = kendo.Class.extend({
    ...
    _initializeView: function () {
        ...
        if (actionName == "editCustomErrorPageItem") {
            var id = this._getParameterByName("customErrorPageItemId");
            that.get_form().show(id);
        }
        else if (actionName == "newCustomErrorPageItem") {
            that.get_form().show();
        }
    },
    ...
    _initializeSortingDropDownList: function () {
        ...
        var sortExpressions = [
            ...
            { text: "By StatusCode (A-Z)", value: "StatusCode ASC" },
            { text: "By StatusCode (Z-A)", value: "StatusCode DESC" },
        ...
        $(this._masterElements.sortingDropDownList).kendoDropDownList({
            ...
            change: function (e) {
                ...
                if (e.sender.dataItem().value == "custom") {
                    $(that._masterElements.customSortingCustomErrorPageItemPropertiesDropDownList).kendoDropDownList({
                        dataTextField: "Name",
                        dataValueField: "Name",
                        dataSource: that.get_customErrorPageItemPropertiesDataSource()
                    });
                    that.set_customSortingCustomErrorPageItemPropertiesDropDownList($(that._masterElements.customSortingCustomErrorPageItemPropertiesDropDownList).data("kendoDropDownList"));
    ...
    _initializeCustomSortingDialog: function (dialogSettings) {
        ...
        this.set_customErrorPageItemPropertiesDataSource(propertiesDataSource);
        ...
        $(this._masterElements.saveCustomSortingButton).click(function () {
            var selectedProperty = that.get_customSortingCustomErrorPageItemPropertiesDropDownList().value();
        ...
        if ($(me._masterElements.batchDeleteButton).is('.sfDisabledLinkBtn')) {
            ...
            $(me._masterElements.batchDeleteButton).on('click', function () {
                ...
                if (checkedTextBoxes.length == 1) {
                    ...
                    $(me._masterElements.batchDeleteCustomErrorPageItemCountLabel).text(checkedTextBoxes.length);
    ...
    get_customErrorPageItemPropertiesDataSource: function () {
        return this._customErrorPageItemPropertiesDataSource;
    },
    set_customErrorPageItemPropertiesDataSource: function (dataSource) {
        this._customErrorPageItemPropertiesDataSource = dataSource;
    },

    get_customSortingCustomErrorPageItemPropertiesDropDownList: function () {
        return this._customSortingCustomErrorPageItemPropertiesDropDownList;
    },
    set_customSortingCustomErrorPageItemPropertiesDropDownList: function (dropDownList) {
        this._customSortingCustomErrorPageItemPropertiesDropDownList = dropDownList;
    },
    ...
    _masterElements: {
        masterGrid: "#customErrorPageItemsGrid",
        pagesWrapper: "#pagesWrapper",
        masterRowTemplate: "#customErrorPageItemsRowTemplate",
        decisionScreen: "#customErrorPageItemsDecisionScreen",
        checkAllCheckbox: "#checkAllCheckbox",
        deleteConfirmationDialog: "#deleteCustomErrorPageItemConfirmationDialog",
        confirmDeleteButton: "#confirmCustomErrorPageItemDeleteButton",
        cancelDeleteButton: "#cancelDeleteCustomErrorPageItemButton",
        batchDeleteButton: "#deleteUserCustomErrorPageItems",
        batchDeleteConfirmationDialog: "#batchDeleteCustomErrorPageItemConfirmationDialog",
        batchDeleteCustomErrorPageItemCountLabel: "#batchDeleteCustomErrorPageItemCountLabel",
        confirmBatchDeleteButton: "#confirmCustomErrorPageItemBatchDeleteButton",
        cancelBatchDeleteButton: "#cancelBatchDeleteCustomErrorPageItemButton",
        sortingDropDownList: "#sortingDropDownList",
        customSortingDialog: "#customErrorPageItemCustomSortingDialog",
        customSortingCustomErrorPageItemPropertiesDropDownList: "#customSortingCustomErrorPageItemPropertiesDropDownList",
    ...
    _customErrorPageItemPropertiesDataSource: null,
    _customSortingCustomErrorPageItemPropertiesDropDownList: null,
